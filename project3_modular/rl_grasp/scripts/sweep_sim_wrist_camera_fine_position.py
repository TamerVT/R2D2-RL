...
OUT_PATH = Path("/tmp/so101_wrist_fine_position_sweep.png")
...
def main() -> None:
    ...
    # Match the real local-grasp setup: closed gripper.
    ...
    candidates = [
        ...
        ("x +1cm",      (0.010,  0.000,  0.000)),
        ("x -1cm",      (-0.010, 0.000,  0.000)),
        ("y +1cm",      (0.000,  0.010,  0.000)),
        ("y -1cm",      (0.000, -0.010,  0.000)),
        ("z +1cm",      (0.000,  0.000,  0.010)),
        ("z -1cm",      (0.000,  0.000, -0.010)),
        ("y+1 z+1",     (0.000,  0.010,  0.010)),
        ("y-1 z+1",     (0.000, -0.010,  0.010)),
    ]
    ...
    print(f"Saved fine position sweep to {OUT_PATH}")
