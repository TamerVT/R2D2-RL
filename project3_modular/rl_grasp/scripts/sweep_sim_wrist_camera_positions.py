...
OUT_PATH = Path("/tmp/so101_wrist_position_sweep.png")
...
def main() -> None:
    ...
    # Current XML position is approximately:
    #   [-0.0079, -0.0002, -0.055]
    #
    # Try moving along local-ish XML coordinates around that point.
    candidates = [
        ("base",        (0.000,  0.000,  0.000)),
        ("z +2cm",      (0.000,  0.000,  0.020)),
        ("z +4cm",      (0.000,  0.000,  0.040)),
        ("y +2cm",      (0.000,  0.020,  0.000)),
        ("y -2cm",      (0.000, -0.020,  0.000)),
        ("x +2cm",      (0.020,  0.000,  0.000)),
        ("x -2cm",      (-0.020, 0.000,  0.000)),
        ("z+2 y+2",     (0.000,  0.020,  0.020)),
        ("z+2 y-2",     (0.000, -0.020,  0.020)),
    ]
