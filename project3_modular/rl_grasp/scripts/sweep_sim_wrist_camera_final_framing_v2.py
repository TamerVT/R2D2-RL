...
OUT_PATH = Path("/tmp/so101_wrist_final_framing_sweep_v2.png")
...
def main() -> None:
    ...
    # Match the real local-grasp setup: gripper closed.
    ...
    candidates = [
        ...
        ("x -0.25cm",        (-0.0025, 0.0000,  0.0000)),
        ("x -0.50cm",        (-0.0050, 0.0000,  0.0000)),
        ("y -0.25cm",        (0.0000, -0.0025,  0.0000)),
        ("y +0.25cm",        (0.0000,  0.0025,  0.0000)),
        ("x-.25 y-.25",      (-0.0025,-0.0025,  0.0000)),
        ("x-.25 y+.25",      (-0.0025, 0.0025,  0.0000)),
        ("x-.25 z+0.25",     (-0.0025, 0.0000,  0.0025)),
        ("x-.25 z-0.25",     (-0.0025, 0.0000, -0.0025)),
    ]
    ...
    print(f"Saved final framing sweep v2 to {OUT_PATH}")
